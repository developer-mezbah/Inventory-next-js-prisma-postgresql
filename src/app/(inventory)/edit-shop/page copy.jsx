  ...
  useEffect(() => {
    if (data?.status) {
      setProfile({
        ...
        currencyCode: data?.company?.currencyCode || "USD",
        currencySymbol: data?.company?.currencySymbol || "$",
        country: data?.company?.country || "",
        countryCode: data?.company?.countryCode || "",
      });
      setImage(data?.company?.logoUrl ? [data?.company?.logoUrl] : []);
      setSignature(
        data?.company?.signatureUrl ? [data?.company?.signatureUrl] : []
      );
    }
  }, [data]);

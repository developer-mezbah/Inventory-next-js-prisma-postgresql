...
export default function CategoryModal({
  ...
  // New function to clear the search query
              ...
              <div className="p-4 sm:p-6 space-y-4">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    style={{ paddingRight: searchQuery ? '2.5rem' : '1rem' }} // Adjusted padding for the clear button
                  />
                  {searchQuery && ( // Conditional rendering of the clear button
                    <button

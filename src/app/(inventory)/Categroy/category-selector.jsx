...
export default function CategorySelector({ category, onOpen }) {
  return (
    <button
      ...
      className="w-full px-4 py-3 border border-blue-400 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 duration-150 shadow-inner flex items-center justify-between hover:opacity-90 transition-opacity text-sm sm:text-base"
    >

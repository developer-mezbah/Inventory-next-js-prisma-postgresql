...
function getTypeColor(type) {
  const colors = {
    ...
    // Added color for "Purchase" type based on common usage
    ...
    <div className="rounded-lg border border-gray-200 bg-white shadow-sm overflow-hidden">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div className="text-left">
            <div className="flex items-center gap-2">
              ...
              {/* Updated: Display Payment Type in the main button */}
        ...
        <div className="text-right">
          {/* Assuming the currency is Thai Baht  from the original code */}
      ...
      {isExpanded && (
        <div className="border-t border-gray-200 bg-gray-50 px-4 py-4 animate-in fade-in duration-200">
          <div className="space-y-3 mb-4">
            ...
            {/* Updated: Display Payment Type in expanded section */}
            <div className="flex justify-between">
              <span className="text-xs font-semibold text-gray-600 uppercase">
                Payment Type
              </span>{" "}

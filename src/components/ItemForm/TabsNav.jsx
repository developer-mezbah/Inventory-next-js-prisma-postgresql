        ...
        <div className="flex border-b border-border/50 bg-card px-4 sm:px-6 overflow-x-auto">
            {tabs.map((tab) => (
                <button
                    ...
                    className={`flex items-center gap-2 cursor-pointer px-3 sm:px-4 py-3 text-sm sm:text-base font-medium border-b-2 transition-colors whitespace-nowrap ${activeTab === tab.id
